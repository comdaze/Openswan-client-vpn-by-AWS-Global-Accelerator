...
### 在EC2上手动部署Openswan
为了理解Openswan的安装步骤，可以按照以下步骤手动安装。
### 安装epel源
...
### 创建/etc/ppp/chap-secrets配置文件，即用户列表及密码
```
...
### 修改service配置文件/usr/lib/systemd/system/xl2tpd.service
```
[Unit]
